...
- **Links:**
  ...
  - Program design: `the-purpose-project/03-program/`
  - Tech/AI concepts: `the-purpose-project/04-tech/`
  - Fundraising & donor materials: `the-purpose-project/05-fundraising/`
  - Ops/legal notes: `the-purpose-project/06-operations/`
- **Next 7 days:**
  - [ ] Define target population (age range, geography, barriers)
  - [ ] Define outcomes (purpose clarity, training completion, job placement, retention)
  - [ ] Draft program arc (assessment → plan → training → placement → mentorship)
